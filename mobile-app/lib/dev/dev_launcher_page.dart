      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            const ColoredBox(color: AppColors.surface, child: SizedBox(height: 1)),
            Expanded(
              child: ListView(
                ...
                children: const [
                  ...
                  _RouteRow(label: 'Workout Selection V2', route: RouteNames.workoutSelectionV2),
                  _RouteRow(label: 'Active Workout', route: RouteNames.activeWorkout),
